...
// i18n ultra-ligero compatible con data-i18n y data-i18n-attr

const DEFAULT_LANG = 'es';
const LS_KEY = 'rvlang';

// Diccionario base (puedes ampliar o reemplazar por carga remota)
const DICT = {
  es: {
    'nav.home': 'Inicio',
...
export function applyI18n(root = document) {
  root.querySelectorAll('[data-i18n]').forEach((el) => {
    ...
    const attr = el.getAttribute('data-i18n-attr'); // ej. placeholder,title,aria-label
    const text = t(key);
